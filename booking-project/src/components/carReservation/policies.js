        ...
        <>
            <section className="institutionalPolicies">
                ...
                <div className="institutionalPoliciesDescription">
                    ...
                    <div>
                        <h3>Importante</h3>
                        <p>En caso de situaciones externas, DIGIRENT se reserva el derecho a modificar el vehículo que se entrega, siendo esta modificación por uno de  gama superior.</p>                    
                    </div>
                </div>
            </section>
        </>
